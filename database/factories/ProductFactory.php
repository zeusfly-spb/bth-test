...
class ProductFactory extends Factory
{
    protected static array $productsByCategory = [
        'Электроника' => [
            ...
            ['name' => 'Флешка Kingston 64GB', 'description' => 'USB 3.2, металлический корпус'],
            ['name' => 'Внешний SSD Samsung T7', 'description' => '1TB, до 1050 МБ/с'],
            ['name' => 'Моноблок Apple iMac', 'description' => '24", M1, 8GB RAM'],
            ['name' => 'Сетевой фильтр APC', 'description' => '6 розеток, защита от перенапряжения'],
        ],
        'Одежда и обувь' => [
            ...
            ['name' => 'Носки термо', 'description' => 'Шерсть, для зимы'],
            ['name' => 'Шорты спортивные', 'description' => 'Сетка, дышащие'],
            ['name' => 'Пальто кашемировое', 'description' => 'Классический крой'],
        ],
        'Дом и сад' => [
            ...
            ['name' => 'Набор полотенец', 'description' => '3 шт, хлопок'],
            ['name' => 'Светильник LED', 'description' => 'Настольный, с регулировкой'],
            ['name' => 'Швабра с отжимом', 'description' => 'Телескопическая ручка'],
        ],
        'Спорт и отдых' => [
            ...
            ['name' => 'Роликовые коньки', 'description' => 'Размер 42, светящиеся колеса'],
            ['name' => 'Палатка туристическая', 'description' => '3-местная, дышащая'],
            ['name' => 'Скакалка', 'description' => 'Регулируемая, с подсчетом'],
        ],
        'Книги' => [
            ...
            ['name' => 'Маленький принц', 'description' => 'Экзюпери, иллюстрации'],
            ['name' => 'Алые паруса', 'description' => 'Грин, подарочное издание'],
            ['name' => 'Дюна', 'description' => 'Фрэнк Герберт, научная фантастика'],
        ],
        'Автотовары' => [
            ...
            ['name' => 'Ароматизатор в авто', 'description' => 'Елка, нейтральный'],
            ['name' => 'Чехлы на сиденья', 'description' => 'Универсальные, дышащие'],
            ['name' => 'Омывайка зимняя', 'description' => '-30°C, 5 литров'],
        ],
        'Детские товары' => [
            ...
            ['name' => 'Погремушка', 'description' => 'Свет, звук, 3+'],
            ['name' => 'Набор пустышек', 'description' => '2 шт, силикон'],
            ['name' => 'Балансир-доска', 'description' => 'Для развития координации'],
        ],
        'Косметика и парфюмерия' => [
            ...
            ['name' => 'Сыворотка для лица', 'description' => 'С витамином C'],
            ['name' => 'Дезодорант кристалл', 'description' => 'Натуральный состав'],
            ['name' => 'Ватные диски', 'description' => '200 шт, мягкие'],
                    ],
        'Зоотовары' => [
            ...
            ['name' => 'Поилка автоматическая', 'description' => '2 литра, фильтр'],
            ['name' => 'Когтерезка', 'description' => 'Для крупных пород'],
            ['name' => 'Лежак круглый', 'description' => 'Мягкий, бортик'],
        ],
        'Строительство и ремонт' => [
            ['name' => 'Перфоратор Makita', 'description' => '850 Вт, 3 режима, SDS+'],
            ['name' => 'Лазерный уровень', 'description' => 'Зеленый луч, самовыравнивание'],
            ['name' => 'Шуруповерт аккумуляторный Bosch', 'description' => '18V, 2 аккумулятора'],
            ['name' => 'Рулетка 5 м', 'description' => 'Магнитный наконечник, двухсторонняя'],
            ['name' => 'Набор сверл по бетону', 'description' => '5 шт, 4-10 мм'],
            ['name' => 'Краска акриловая белая 3 кг', 'description' => 'Для стен и потолков'],
            ['name' => 'Валик малярный', 'description' => '25 см, ворс 12 мм'],
            ['name' => 'Малярный скотч', 'description' => '50 мм, 50 м, для ровных линий'],
            ['name' => 'Углошлифовальная машина', 'description' => '125 мм, 1100 Вт'],
            ['name' => 'Строительный фен', 'description' => '1600 Вт, 2 температуры'],
        ],
        'Медицина и здоровье' => [
            ['name' => 'Тонометр автоматический', 'description' => 'На плечо, память на 60 измерений'],
            ['name' => 'Пульсоксиметр', 'description' => 'На палец, SpO2, пульс'],
            ['name' => 'Витамин D3', 'description' => '2000 МЕ, капли'],
            ['name' => 'Ингалятор компрессорный', 'description' => 'Для детей и взрослых'],
            ['name' => 'Ортопедическая подушка', 'description' => 'С эффектом памяти, анатомическая'],
            ['name' => 'Градусник электронный', 'description' => 'Гибкий наконечник, водозащита'],
            ['name' => 'Набор пластырей', 'description' => '20 шт, дышащие, разные размеры'],
            ['name' => 'Магний B6', 'description' => 'Таблетки, 60 шт'],
            ['name' => 'Эластичный бинт', 'description' => '5 м, фиксирующий'],
            ['name' => 'Небулайзер', 'description' => 'Ультразвуковой, для домашнего использования'],
        ],
    ];
